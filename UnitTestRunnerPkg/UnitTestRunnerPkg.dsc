...
################################################################################
[Defines]
  PLATFORM_NAME                  = UnitTestRunner
  PLATFORM_GUID                  = 7CBFA909-BCAC-441E-ABA4-E7BC279C1190
  PLATFORM_VERSION               = 0.4
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/UnitTestRunner_$(ARCH)
  SUPPORTED_ARCHITECTURES        = IA32|X64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = UnitTestRunnerPkg/UnitTestRunnerPkg.fdf
  #
...
[LibraryClasses]
  ...
  # Platform
  #
  PlatformBootManagerLib|UnitTestRunnerPkg/Library/PlatformBootManagerLib/PlatformBootManagerLib.inf
  #
  # Misc
  #
...
[PcdsFeatureFlag]
  ...
  #
  gEfiUnitTestConfigGuid.PcdOutputTestResultsToDebugLog|FALSE
  gEfiUnitTestConfigGuid.PcdOutputTestResultsToXmlFile|TRUE
  gEfiUnitTestConfigGuid.PcdResetAfterTestResultsAreSaved|TRUE
...
[PcdsFixedAtBuild]
  ...
  gEfiNt32PkgTokenSpaceGuid.PcdWinNtFirmwareVolume|L"Nt32.fd!UnitTest.fd"
...
!endif
  ...
  #
  # Unit Test Results XML File Name
  #
  gEfiUnitTestConfigGuid.PcdTestResultsXmlFileName|L"TestResults.xml"
...
[PcdsDynamicDefault.common.DEFAULT]
  gEfiNt32PkgTokenSpaceGuid.PcdWinNtSerialPort|L""|VOID*|2
  gEfiNt32PkgTokenSpaceGuid.PcdWinNtGop|L""|VOID*|52
  gEfiNt32PkgTokenSpaceGuid.PcdWinNtConsole|L"Bus Driver Console Window"|VOID*|52
  gEfiNt32PkgTokenSpaceGuid.PcdWinNtVirtualDisk|L""|VOID*|2
  gEfiNt32PkgTokenSpaceGuid.PcdWinNtMemorySize|L"64!64"|VOID*|12
  gEfiNt32PkgTokenSpaceGuid.PcdWinNtPhysicalDisk|L""|VOID*|2
  gEfiNt32PkgTokenSpaceGuid.PcdWinNtUga|L""|VOID*|2
...
[Components]
  ...
  <BuildOptions>
    ...
    # Add override to build with statically linked C runtime instead of dynamically linked
  ...
  UnitTestRunnerPkg/WinNtFirmwareVolumePei/WinNtFirmwareVolumePei.inf
...
#
  ...
  UnitTestPkg/UnitTestHobDxe/UnitTestHobDxe.inf
