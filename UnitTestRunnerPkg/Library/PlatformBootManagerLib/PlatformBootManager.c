...
EFI_GUID mSaveTestResultsGuid = { 0x226EC403, 0x2ACC, 0x4D0A, 0xAC, 0xE9, 0x9B, 0x09, 0x2E, 0x07, 0x5B, 0x0C };
  ...
  )
{
  ...
  //
  PlatformRegisterFvBootOption (&mSaveTestResultsGuid, L"Unit Test Results", LOAD_OPTION_ACTIVE);
  //
  // Register UEFI Shell
  //
