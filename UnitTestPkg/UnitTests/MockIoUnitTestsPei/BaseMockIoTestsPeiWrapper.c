/** @file
  PEI Wrapper for Base Mock I/O Unit Tests
...
BEGIN_TEST_SUITE (MockIoPeiUnitTests)
  &GetMockSizeTestCase,
  ...
  &TestGetMockData,
  &TestSetMockData
END_TEST_SUITE (MockIoPeiUnitTests)
  ...
  )
{
  ...
  RunTestSuite (&MockIoPeiUnitTests, &TestResults[0]);
}
